...
import 'package:baseflutter/src/base/theme/path.theme.base.dart';
...
abstract class BaseScreen extends StatelessWidget {
  ...
  BoxDecoration initBackground() {
    return (BR_PATH == "") ? brImage(BR_PATH) : brColor();
  }

  BoxDecoration brImage(String path) {
    return BoxDecoration(
        image: DecorationImage(image: AssetImage(path), fit: BoxFit.cover));
  }

  BoxDecoration brColor() {
    return BoxDecoration(color: Colors.purple);
  }
